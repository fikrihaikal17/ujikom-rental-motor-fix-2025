  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="space-y-8">
      ...
      <div class="bg-white shadow-sm rounded-lg overflow-hidden">
        ...
        <form method="POST" action="{{ route('renter.settings.update') }}" class="px-6 py-6">
          @csrf
          @method('PUT')
            ...
            <div>
              ...
              <div class="relative">
                <input 
                  ...
                  class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('current_password') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                  required
                >
              ...
              @enderror
              <p class="mt-1 text-xs text-gray-500">Wajib diisi untuk keamanan</p>
            </div>
              ...
              <div class="space-y-4">
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-sm text-gray-500">
                      Terima notifikasi melalui email untuk konfirmasi booking, status penyewaan, dan pembaruan pembayaran.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-sm text-gray-500">
                      Terima notifikasi melalui SMS untuk booking urgent dan pengingat penting.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-sm text-gray-500">
                      Terima notifikasi real-time di browser untuk status booking dan promo terbaru.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    <label for="notification_promo" class="font-medium text-gray-700">
                      Notifikasi Promo
                    </label>
                    <p class="text-sm text-gray-500">
                      Terima informasi promo menarik, diskon khusus, dan penawaran motor terbaru.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-sm text-gray-600">Penyewa Motor</p>
                </div>
              </div>
            </div>
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <p class="mt-1 text-sm text-gray-900">{{ $user->no_hp ?? 'Belum diisi' }}</p>
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700">Alamat</label>
                <p class="mt-1 text-sm text-gray-900">{{ $user->alamat ?? 'Belum diisi' }}</p>
              </div>
            </div>
          </div>
        </div>
