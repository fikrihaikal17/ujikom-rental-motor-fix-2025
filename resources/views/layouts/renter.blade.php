              ...
              <div class="border-t border-gray-200 pt-4 px-2">
                ...
                <div x-data="{ accountOpen: false }" class="relative">
                  ...
                  <div x-show="accountOpen"
                    ...
                    <!-- Profile Menu Item -->
                    <a href="{{ route('renter.profile') }}" class="group flex items-center gap-x-3 px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-700 hover:bg-blue-50 transition-colors duration-200">
                    ...
                    <!-- Settings Menu Item -->
                    <a href="{{ route('renter.settings') }}" class="group flex items-center gap-x-3 px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-700 hover:bg-blue-50 transition-colors duration-200">
                      <div class="flex h-5 w-5 shrink-0 items-center justify-center">
                        <svg class="h-4 w-4 text-gray-400 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <li class="mt-auto">
                  <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="space-y-1">
                      <a href="{{ route('renter.profile') }}" @click="sidebarOpen = false" class="group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-medium text-gray-700 hover:text-primary-700 hover:bg-gray-50">
                      ...
                      <a href="{{ route('renter.settings') }}" @click="sidebarOpen = false" class="group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-medium text-gray-700 hover:text-primary-700 hover:bg-gray-50">
                        <svg class="h-5 w-5 shrink-0 text-gray-400 group-hover:text-primary-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
