    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 shadow-lg">
        ...
        <div class="flex h-16 shrink-0 items-center">
          ...
          <span class="ml-2 text-sm text-gray-500">Pemilik Motor</span>
        </div>
              ...
              <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                  <a href="{{ route('owner.dashboard') }}"
                    ...
                    <x-icons.dashboard class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.dashboard') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Dashboard
                  </a>
                </li>
                ...
                <li>
                  <a href="{{ route('owner.motors.index') }}"
                    ...
                    <x-icons.motor class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.motors.*') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Kelola Motor
                  </a>
                </li>
                ...
                <!-- Kelola Tarif -->
                <li>
                  <a href="{{ route('owner.tariffs.index') }}"
                    class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('owner.tariffs.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:text-primary-700 hover:bg-gray-50' }}">
                    <x-icons.currency class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.tariffs.*') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Kelola Tarif
                  </a>
                </li>
                ...
                <li>
                  <a href="{{ route('owner.bookings.index') }}"
                    class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('owner.bookings.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:text-primary-700 hover:bg-gray-50' }}">
                    <x-icons.clipboard class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.bookings.*') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Riwayat Penyewaan
                  </a>
                </li>
                ...
                <li>
                  <a href="{{ route('owner.earnings.index') }}"
                    class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('owner.earnings.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:text-primary-700 hover:bg-gray-50' }}">
                    <x-icons.chart class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.earnings.*') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Laporan Pendapatan
                  </a>
                </li>
                ...
                <!-- Bagi Hasil -->
                <li>
                  <a href="{{ route('owner.revenue-sharing.index') }}"
                    class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('owner.revenue-sharing.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:text-primary-700 hover:bg-gray-50' }}">
                    <x-icons.currency class="h-6 w-6 shrink-0 {{ request()->routeIs('owner.revenue-sharing.*') ? 'text-primary-700' : 'text-gray-400 group-hover:text-primary-700' }}" />
                    Bagi Hasil
                  </a>
                </li>
              </ul>
              ...
              <div class="border-t border-gray-200 pt-4">
                <div class="flex items-center px-2">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="text-xs text-gray-500">Pemilik Motor</div>
                  </div>
                </div>
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6 ml-auto">
            ...
            <div class="hidden md:flex items-center space-x-4 text-sm">
              <div class="text-gray-500">Motor Aktif: <span class="font-medium text-gray-900">{{ auth()->user()->motors()->where('status', 'available')->count() ?? 0 }}</span></div>
              <div class="text-gray-500">Sedang Disewa: <span class="font-medium text-gray-900">{{ auth()->user()->motors()->where('status', 'rented')->count() ?? 0 }}</span></div>
            </div>
