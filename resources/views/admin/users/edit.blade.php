...
<div class="mb-8">
  <div class="flex items-center">
    ...
    <div>
      ...
      <p class="mt-2 text-sm text-gray-700">Ubah informasi pengguna {{ $user->nama }}.</p>
    </div>
  </div>
</div>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          ...
          <textarea name="alamat" id="alamat" rows="3"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm @error('alamat') border-red-300 @enderror">{{ old('alamat', $user->alamat) }}</textarea>
          @error('alamat')
          <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
          @enderror
        </div>
